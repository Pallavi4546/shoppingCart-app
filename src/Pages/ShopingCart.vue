            ...
            <div v-for="(item, i) in data" :key="i">
                <div class="card m-3 p-2">
                    ...
                    <div class="buttonData">
                        <button class="btn1 m-2" v-for="(data, k) in item.colors" :key="k" @click="selectedColor(data)"
                            :style="`background:${data};border:none;width:30px;height:30px;border-radius:50%;box-shadow: 4px 4px 4px 4px #f5f5f5;`"></button>
                    </div>
                    <div class="buttonData">
                        <button class="btn m-1" v-for="(val, l) in item.sizes" :key="l" @click="size(val)">{{
                            val
                        }}</button>
                    </div>
